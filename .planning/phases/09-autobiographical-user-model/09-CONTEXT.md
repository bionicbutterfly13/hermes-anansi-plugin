# Phase 9: Autobiographical User Model - Context
...
- Dependencies: Phase 8. Phase numbers alone add no dependencies.
...
Preserve the agreed worldview-first sequence, then episode/autobiography and user-dopamine.
